...
<html>
<head>
<title>BeInShape Gym | Главная</title>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right wow fadeInRight animated" data-wow-delay="0.4s">
				...
				<li><a class="nav-in" href="contact.html"><span data-letters="Контакты">Контакты</span></a></li>
          </ul>
        </div>
      </div>
    </nav>
						...
						<div class="fit-grids">
							<div class="col-md-4 fit-grid wow fadeInDownBig animated" data-wow-delay="0.4s">
								<div class="fit-left hvr-bounce-to-bottom">
									<h3>Режим работы</h3>
									<ul>
									<li>Понедельник - Пятница : 09:00 - 20:00</li>
								...
								<div class="col-md-6 benefits-grid wow fadeInLeft animated" data-wow-delay="0.4s">
									...
									<div class="benefit-top">
										...
										<div class="benefit-right">
											<p> В нашем зале много пространства. Одновременно могут заниматься большое количество людей.</p>
										</div>
										<div class="clearfix"></div>
									</div>
									<div class="benefit-top">
										...
										<div class="benefit-right">
											<p> Только новые и современные тренажеры. Заниматься на них одно удовольствие.</p>
										</div>
										<div class="clearfix"></div>
										...
										<div class="benefit-right">
											<p> Удобное место расположения. Добраться из любой тоски города не проблема.</p>
										</div>
										<div class="clearfix"></div>
									</div>
									<div class="benefit-top">
										...
										<div class="benefit-right">
											<p> Команда высококлассных специалистов помогут сделать тренировку эффетивной.</p>
										</div>
										<div class="clearfix"></div>
									</div>
								</div>
